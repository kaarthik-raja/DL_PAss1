...
def main():
	...
	parser.add_argument("--sizes", type=csv_list, help="# of Nodes per H_Layer", default= [200])
	...
	parser.add_argument("--epoch", type=int, help="# of Epochs", default= 10)
...
#====================
	...
	fn="test_submission_M1"+activation+"_"+"_".join([str(e) for e in sizes[:-1]])+"_"+str(int((nofp*10000)/(valid.shape[0])) )+".csv"
